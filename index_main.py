...
class CarRacing:
    ...
    def initialize(self):
        ...
        pygame.mixer.music.set_volume(0.4)  # Set the volume (optional)
        ...
        while not self.crashed:
            ...
            if self.car_y_coordinate < self.enemy_car_starty + self.enemy_car_height:
                if (self.car_x_coordinate > self.enemy_car_startx and self.car_x_coordinate < self.enemy_car_startx + self.enemy_car_width) or (
                    ...
                    self.crashed = True
                    self.display_message("created by harsh")

            if self.car_x_coordinate < 310 or self.car_x_coordinate > 460:
                self.crashed = True
                self.display_message("noob created by harsh")
    ...
    def display_message(self, msg):
        ...
        self.clock.tick(60)
        sleep(1)
        self.initialize()  # Use self.initialize() instead of car_racing.initialize()
        self.racing_window()  # Use self.racing_window() instead of car_racing.racing_window()
    ...
    def display_credit(self):
        ...
        text = font.render("created by harsh", True, self.white)
